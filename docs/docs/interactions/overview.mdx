...
Make sure you've also followed the [Installation steps](/installation) for `moti`. You'll need to use the version of `moti` that is compatible with `@motify/interactions`:
